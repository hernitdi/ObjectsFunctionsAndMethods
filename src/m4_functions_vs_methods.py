...
def try_methods_and_functions():
    ...
    #
    ####################################################################
    juicy = rg.SimpleTurtle()
    juicy.pen = rg.Pen('blue', 5)
    juicy.backward(150)
    juicy.speed = 1
    draw_many_squares(juicy, 2, 100, 30)
    juicy.speed = 5
    juicy.pen = rg.Pen('red', 5)
    draw_many_squares(juicy, 10, 50, 15)
    juicy.speed = 100
    juicy.pen = rg.Pen('red', 35)
    draw_many_squares(juicy, 8, 300, 60)
    juicy.pen = rg.Pen('black', 3)
    juicy.backward(200)
    juicy.draw_circle(30)
    juicy.draw_square(50)
