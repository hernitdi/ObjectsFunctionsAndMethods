...
def turtle4() :
    ...
    george.pen = rg.Pen('red', 15)
    george.forward(20)
    george.begin_fill()
    george.draw_regular_polygon(7,100)
    george.end_fill()

def turtle5() :
    luci = rg.SimpleTurtle()
    luci.pen = rg.Pen('yellow', 5)
    luci.backward(50)
    luci.draw_square(5)
    marquese = rg.SimpleTurtle()
    marquese.pen = rg.Pen('orange',7)
    marquese.begin_fill()
    marquese.draw_circle(20)
    marquese.end_fill()
